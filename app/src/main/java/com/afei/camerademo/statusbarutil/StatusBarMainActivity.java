package com.afei.camerademo.statusbarutil;
...
public class StatusBarMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statusbar_main);
        ...
        mBtnSetColor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StatusBarMainActivity.this, ColorStatusBarActivity.class);
        ...
        mBtnSetTransparent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StatusBarMainActivity.this, ImageStatusBarActivity.class);
        ...
        mBtnSetForImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StatusBarMainActivity.this, ImageViewActivity.class);
                startActivity(intent);
            }
        });
        ...
        mBtnUseInFragment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StatusBarMainActivity.this, UseInFragmentActivity.class);
                startActivity(intent);
            }
        });
        ...
        mBtnSetColorForSwipeBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StatusBarMainActivity.this, SwipeBackActivity.class);
                startActivity(intent);
            }
        });
        ...
        mBtnSwitchMode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(StatusBarMainActivity.this, SwitchModeActivity.class);
                startActivity(intent);
            }
        });
        ...
        mChbTranslucent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtil.setTranslucentForDrawerLayout(StatusBarMainActivity.this, mDrawerLayout, mAlpha);
                    mToolbar.setBackgroundColor(getResources().getColor(android.R.color.transparent));
                } else {
                    contentLayout.setBackgroundDrawable(null);
                    mToolbar.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                    StatusBarUtil.setColorForDrawerLayout(StatusBarMainActivity.this, mDrawerLayout,
        ...
        mSbChangeAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (mChbTranslucent.isChecked()) {
                    ...
                    StatusBarUtil.setColorForDrawerLayout(StatusBarMainActivity.this, mDrawerLayout, mStatusBarColor, mAlpha);
                }
